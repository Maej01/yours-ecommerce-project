        ...
        <div class="row">
            ...
            <div class="card-panel">
                    <!-- <div class="bzoom_wrap"> -->
                        <ul id="bzoom">
                            <li>
                                <img class="bzoom_thumb_image" src="/group_web/public_files/images/products/sneakers/nike_men_air.jpg">
                                <img class="bzoom_big_image" src="/group_web/public_files/images/products/sneakers/nike_men_air.jpg">
                            </li>
                            <li>
                                <img class="bzoom_thumb_image" src="/group_web/public_files/images/products/sneakers/nike_men_air.jpg">
                                <img class="bzoom_big_image" src="/group_web/public_files/images/products/sneakers/nike_men_air.jpg">
            ...
            <div class="col s12 m4">
                ...
                <div class="row displayPrice">
                    <div class="col s6 m6 details">
                        <label>List Price:</label><span><del>US $60.00</del></span>
                        <br>
                        <label>You save:</label><span>US $10)</span>
                        <br>
                        <label>Now:</label><span>USD $50</span>
                    </div>
