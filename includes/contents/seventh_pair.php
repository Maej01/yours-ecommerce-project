        ...
        <div class="row">
            ...
            <div class="card-panel">
                    <!-- <div class="bzoom_wrap"> -->
                        <ul id="bzoom">
                            <li>
                                <img class="bzoom_thumb_image" src="/group_web/public_files/images/products/sneakers/vans_3.JPG">
                                <img class="bzoom_big_image" src="/group_web/public_files/images/products/sneakers/vans_3.JPG">
                            </li>
                            <li>
                                <img class="bzoom_thumb_image" src="/group_web/public_files/images/products/sneakers/vans_3.JPG">
                                <img class="bzoom_big_image" src="/group_webpublic_files/images/products/sneakers/vans_3.JPG">
                            </li>
                            <li>
                                <img class="bzoom_thumb_image" src="/group_web/public_files/images/products/sneakers/vans_3.JPG">
                                <img class="bzoom_big_image" src="/group_web/public_files/images/products/sneakers/vans_3.JPG">
            ...
            <div class="col s12 m4">
                <h5>NIKE SPON - acc</h5>
                <p class="red-text">10 views per day</p>
                ...
                <div class="product_desc">
                    ...
                    <div class="row">
                        ...
                        <div class="col s6 m8 right push-m1">
                            ...
                            <label class="red-text">50 sold</label>
                        </div>
                    </div>
                </div>
                <div class="divider"></div>
                <div class="row displayPrice">
                    <div class="col s6 m6 details">
                        <label>List Price:</label><span><del>US $57</del></span>
                        <br>
                        <label>You save:</label><span>US $0</span>
                        <br>
                        <label>Now:</label><span>USD $57</span>
                    </div>
