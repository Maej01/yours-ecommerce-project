        ...
        <div class="row">
            ...
            <div class="card-panel">
                    <!-- <div class="bzoom_wrap"> -->
                        <ul id="bzoom">
                            <li>
                                <img class="bzoom_thumb_image" src="/group_web/public_files/images/products/sneakers/Adidas-Yeezy-Boost-350.jpg">
                                <img class="bzoom_big_image" src="/group_web/public_files/images/products/sneakers/Adidas-Yeezy-Boost-350.jpg">
                            </li>
                            <li>
                                <img class="bzoom_thumb_image" src="/group_web/public_files/images/products/sneakers/Adidas-Yeezy-Boost-350.jpg">
                                <img class="bzoom_big_image" src="/group_web/public_files/images/products/sneakers/Adidas-Yeezy-Boost-350.jpg">
            ...
            <!-- product section -->
            <div class="col s12 m4">
                <h5>ADIDAS YEEZY BOOST - Checked</h5>
                <p class="red-text">125 views per day</p>
                ...
                <div class="product_desc">
                    ...
                    <div class="row">
                        ...
                        <div class="col s6 m8 right push-m1">
                            ...
                            <label class="red-text">100 sold</label>
                        </div>
                    </div>
                </div>
                <div class="divider"></div>
                <div class="row displayPrice">
                    <div class="col s6 m6 details">
                        <label>List Price:</label><span><del>US $90.00</del></span>
                        <br>
                        <label>You save:</label><span>US $10.00(1% off)</span>
                        <br>
                        <label>Now:</label><span>USD $80.0</span>
                    </div>
