        ...
        <div class="row">
            ...
            <div class="card-panel">
                    <!-- <div class="bzoom_wrap"> -->
                        <ul id="bzoom">
                            <li>
                                <img class="bzoom_thumb_image" src="/group_web/public_files/images/products/sneakers/nike-air-vapormax-plus.jpg">
                                <img class="bzoom_big_image" src="/group_web/public_files/images/products/sneakers/nike-air-vapormax-plus.jpg">
                            </li>
                            <li>
                                <img class="bzoom_thumb_image" src="/group_web/public_files/images/products/sneakers/nike-air-vapormax-plus.jpg">
                                <img class="bzoom_big_image" src="/group_web/public_files/images/products/sneakers/nike-air-vapormax-plus.jpg">
            ...
            <!-- product section -->
            <div class="col s12 m4">
                <h5>NIKE AIR VAPOUR MAX</h5>
                <p class="red-text">15 views per day</p>
                ...
                <div class="row displayPrice">
                    <div class="col s6 m6 details">
                        <label>List Price:</label><span>US $150.00</span>
                        <br>
                        <label>You save:</label><span>US $0</span>
                        <br>
                        <label>Now:</label><span>USD $150.00</span>
                    </div>
