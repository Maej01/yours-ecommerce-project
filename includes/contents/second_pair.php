        ...
        <div class="row">
            ...
            <div class="card-panel">
                    <!-- <div class="bzoom_wrap"> -->
                        <ul id="bzoom">
                            <li>
                                <img class="bzoom_thumb_image" src="/group_web/public_files/images/products/sneakers/Adidas.jpg">
                                <img class="bzoom_big_image" src="/group_web/public_files/images/products/sneakers/Adidas.jpg">
                            </li>
                            <li>
                                <img class="bzoom_thumb_image" src="/group_web/public_files/images/products/sneakers/Adidas.jpg">
                                <img class="bzoom_big_image" src="/group_web/public_files/images/products/sneakers/Adidas.jpg">
            ...
            <div class="col s12 m4">
                <h5>ADIDAS</h5>
                <p class="red-text">16 views per day</p>
                ...
                <div class="product_desc">
                    ...
                    <div class="row">
                        ...
                        <div class="col s6 m8 right push-m1">
                            ...
                            <label class="red-text">10 sold</label>
                        </div>
                    </div>
                </div>
                <div class="divider"></div>
                <div class="row displayPrice">
                    <div class="col s6 m6 details">
                        <label>List Price:</label><span><del>US $100.00</del></span>
                        <br>
                        <label>You save:</label><span>US $20.10(20% off)</span>
                        <br>
                        <label>Now:</label><span>USD $76.9</span>
                    </div>
