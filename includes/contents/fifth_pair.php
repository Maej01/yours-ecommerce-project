        ...
        <div class="row">
            ...
            <div class="card-panel">
                    <!-- <div class="bzoom_wrap"> -->
                        <ul id="bzoom">
                            <li>
                                <img class="bzoom_thumb_image" src="/group_web/public_files/images/products/sneakers/shield-man-shoe.jpg">
                                <img class="bzoom_big_image" src="/group_web/public_files/images/products/sneakers/shield-man-shoe.jpg">
                            </li>
                            <li>
                                <img class="bzoom_thumb_image" src="/group_web/public_files/images/products/sneakers/shield-man-shoe.jpg">
                                <img class="bzoom_big_image" src="/group_webpublic_files/images/products/sneakers/shield-man-shoe.jpg">
                            </li>
                            <li>
                                <img class="bzoom_thumb_image" src="/group_web/public_files/images/products/sneakers/shield-man-shoe.jpg">
                                <img class="bzoom_big_image" src="/group_web/public_files/images/products/sneakers/shield-man-shoe.jpg">
            ...
            <div class="col s12 m4">
                ...
                <div class="row displayPrice">
                    <div class="col s6 m6 details">
                        <label>List Price:</label><span><del>US $100</del></span>
                        <br>
                        <label>You save:</label><span>US $55</span>
                        <br>
                        <label>Now:</label><span>USD $45</span>
                    </div>
